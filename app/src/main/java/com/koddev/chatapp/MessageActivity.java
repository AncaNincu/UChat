...
public class MessageActivity extends AppCompatActivity {
    ...
    private void sendMessage(String sender, final String receiver, String message, String messageType) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (438 == requestCode && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            uploadTask.continueWithTask(new Continuation() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        final String message = myUrl.toString();
                        sendMessage(fuser.getUid(), userid, message, "image");
                        loadingBar.dismiss();
